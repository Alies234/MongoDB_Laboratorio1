 ...
 * @author Daniel
 */
public class PeliculaInterfaz extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeliculaInterfaz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
